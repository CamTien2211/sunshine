    ...
    <section class="content">
        <div class="error-page">
            ...
            <div class="error-content">
                ...
                <p>
                    Chúng tôi đã cố gắng tìm, nhưng mã lỗi không được phân quyền <a href="{{ route('frontend.home') }}">quay về Trang chủ</a> và xem tiếp các sản phẩm khác của chúng tôi!
                </p>
            </div>
        </div>
    </section>
